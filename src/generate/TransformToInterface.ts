...
`;
	...
	await saveInterface(options, result);
}

async function saveInterface(
	{ outputTypescriptDefinitions }: IOptions,
	result: string
) {
	if (typeof outputTypescriptDefinitions !== 'string') {
		return;
	}

	await FormatAndSave(outputTypescriptDefinitions, 'typescript', result);
}
